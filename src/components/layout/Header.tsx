    ...
    <header className="sticky top-0 z-40 bg-ink text-ink-foreground">
      <div className="mx-auto flex h-20 max-w-6xl items-center justify-between px-5 sm:px-8">
        <Link href="/" className="flex items-center gap-3">
          <Image src="/logo-icon.png" alt="" aria-hidden width={36} height={52} className="h-9 w-auto" priority />
          <span className="font-serif text-2xl tracking-[0.3em]">{brandName}</span>
        </Link>
